            ...
            <div class="col-lg-12">
              ...
              <nav aria-label="breadcrumb">
                <ol class="breadcrumb">
                  ...
                  <li aria-current="page" class="breadcrumb-item active">สินค้าทั้งหมด</li>
                </ol>
              </nav>
            </div>
            <div class="col-lg-3">
              ...
              <div class="card sidebar-menu mb-4">
                ...
                <div class="card-body">
                  <ul class="nav nav-pills flex-column category-menu">
                    <li><a href="category" class="nav-link active">สินค้าทั้งหมด <span class="badge badge-secondary">42</span></a>
