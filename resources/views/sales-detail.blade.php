            ...
            <div class="col-lg-12">
              ...
              <nav aria-label="breadcrumb">
                <ol class="breadcrumb">
                  ...
                  <li class="breadcrumb-item"><a href="sales-list">สต็อกสินค้า</a></li>
                  <li aria-current="page" class="breadcrumb-item active">เพิ่มสินค้า</li>
                </ol>
              </nav>
            </div>
            <div class="col-lg-3">
              ...
              *** CUSTOMER MENU ***
              ...
              <div class="card sidebar-menu">
                <div class="card-header">
                  <h3 class="h4 card-title">Seller section</h3>
                </div>
                <div class="card-body">
                  <ul class="nav nav-pills flex-column">
                  <a href="/profile" class="nav-link "><i class="fa fa-user"></i> My Profile</a>
                    <a href="/profile/stock" class="nav-link  active"><i class="fa fa-list "></i> สต็อกสินค้า</a>
...
<!-- แก้ทีหลัง -->
<div class="form-group">
<img src="https://www.linhzhimin.com/wp-content/uploads/2015/03/%E0%B8%AB%E0%B8%A5%E0%B8%B4%E0%B8%99%E0%B8%88%E0%B8%B7%E0%B8%AD%E0%B8%A1%E0%B8%B4%E0%B8%99-granat.jpg" class="avatar img-circle img-thumbnail" alt="avatar">
...
<div class="form-group">
  <label for="number">ขนาดสินค้า(weight)</label>
  <input type="text" id="number" class="form-control" value="3 กรัม">
</div>

<div class="form-group">
  <label for="Brix">ค่าความหวาน(Brix)</label>
  <input id="Brix" type="number" class="form-control" min="1" max="99" value="5">
</div>
...
<div class="form-group">
  <label for="price">ราคา(ต่อกิโล)</label>
  <input id="price" type="text" class="form-control" value="50 บาท">
</div>

<div class="form-group">
  <label for="sell">ผลิตโดย</label>
  <input id="sell" type="text" class="form-control" value="ทัมทิมฟาร์ม">
</div>

<div class="form-group">
  <label for="Stock">สต็อก</label>
  <input id="Stock" type="number" class="form-control" min="1" max="999" value="99">
</div>

<div class="text-center">
  <button type="submit" class="btn btn-primary"> แก้ไข </button>
  <a href="/profile/stock">
