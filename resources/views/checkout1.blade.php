      ...
      *** TOPBAR ***
      ...
      -->
        <div id="top">
            <div class="container">
                <div class="row">
                    <div class="col-lg-6 offer mb-3 mb-lg-0"><a href="#" class="btn btn-success btn-sm">Marketplace
                            Smart Farming</a><a href="#" class="ml-1">สินค้าเกษตรคุณภาพดี!</a></div>
                            ...
                            <form method="get" action="checkout2">
                                ...
                                <div class="nav flex-column flex-md-row nav-pills text-center"><a href="checkout1"
                                        class="nav-link flex-sm-fill text-sm-center active"> <i
                                            class="fa fa-map-marker"> </i>Address</a><a href="#"
                                        ...
                                        <div class="col-md-6 col-lg-3">
                                            <div class="form-group">
                                                ...
                                                <select id="state" class="form-control">
                                                    ...
                                                    <option value="Åland Islands">B</option>
                                                    <option value="Albania">C</option>
                                                    <option value="Algeria">D</option>
                                                </select>
                                            </div>
                                        </div>
                                        <div class="col-md-6 col-lg-3">
                                            <div class="form-group">
                                                ...
                                                <select id="country" class="form-control">
                                                    ...
                                                    <option value="Åland Islands">South Korea</option>
                                                    <option value="Albania">China</option>
                                                    <option value="Algeria">Cambodia</option>
                                                </select>
                                            </div>
                                        </div>
                                        <div class="col-md-6">
