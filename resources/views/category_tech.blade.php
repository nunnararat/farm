      ...
      <div id="content">
        <div class="container">
          <div class="row">
            <div class="col-lg-12">
              ...
              <nav aria-label="breadcrumb">
                <ol class="breadcrumb">
                  ...
                  <li aria-current="page" class="breadcrumb-item active">อุปกรณ์เทคโนโลยีการเกษตร</li>
                </ol>
              </nav>
            </div>
            <div class="col-lg-3">
                  ...
                  <ul class="nav nav-pills flex-column category-menu">
                    <li><a href="category" class="nav-link">สินค้าทั้งหมด <span class="badge badge-secondary">42</span></a>
                        <ul class="list-unstyled">
                          ...
                          <li><a href="category_tech" class="nav-link active">อุปกรณ์เทคโนโลยีการเกษตร</a></li>
                        </ul>
                      </li>
                  </ul>
                </div>
            ...
            <div class="col-lg-9">
              <div class="box">
                <h1>อุปกรณ์เทคโนโลยีการเกษตร</h1>
