            ...
            <div id="checkout" class="col-lg-9">
              <div class="box">
                <form method="get" action="checkout4">
                  ...
                  <!-- /.content-->
                  <div class="box-footer d-flex justify-content-between"><a href="checkout2" class="btn btn-outline-secondary"><i class="fa fa-chevron-left"></i>Back to Shipping Method</a>
