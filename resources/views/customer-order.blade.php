              ...
              <div class="box">
                ...
                <div class="table-responsive mb-4">
                  <table class="table">
                    ...
                    <tbody>
                      <tr>
                        <td><a href="#"><img src="<?php echo url('/'); ?>/img/detailsquare.jpg" alt="White Blouse Armani"></a></td>
                      ...
                      <tr>
                        <td><a href="#"><img src="<?php echo url('/'); ?>/img/basketsquare.jpg" alt="Black Blouse Armani"></a></td>
